...
describe("Organizations :: Commands :: Revoke Administrate Permission", function() {
	...
	xit("returns a 200 when the user has administrate permission and it is successfully revoked", function() {
	});

	xit("returns a 401 when the requester is not in the same organization as the user", function() {
	});

	xit("returns a 401 when requested by a user with manage permission on the organization", function() {
