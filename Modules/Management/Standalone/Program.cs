...
namespace Trackwane.Management.Standalone
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            HostFactory.Run(x =>
            {
                ...
                x.Service<EngineHost<Engine.Registry>>(s =>
                {
                    ...
                    {
                        Events = typeof(_Management_Events_Assembly_).Assembly.GetDomainEvents().Union(typeof(_Access_Control_Events_Assembly_).Assembly.GetDomainEvents()),
