...
namespace Trackwane.Simulator.Web
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            var handler = container.GetInstance<RefreshBusPositionsHandler>();
        ...
        public static void RunJob(RefreshBusPositionsHandler handler, int[] buses)
        {
            handler.Handle(new RefreshBusPositions
            {
                Buses = buses
            });
        }
