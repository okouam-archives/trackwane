...
app.config(function ($stateProvider, $urlRouterProvider, $mdThemingProvider) {
	$mdThemingProvider.theme('default').primaryPalette('blue').accentPalette('blue').dark();
	...
	}).state('timelines', { url: "/timelines", template: '<timelines-page class="page" />' }).state('notifications', { url: "/notifications", template: '<notifications-page class="page" />' }).state('access-control', { url: "/access-control", template: '<access-control-page class="page" />' }).state('dashboard', {
...
(function () {
	...
	angular.module("trackwane").service('services.applicationState', [function () {
		...
		this.trackers = [{ identifier: "A SENSOR IDENTIFIER" }, { identifier: "A SENSOR A" }, { identifier: "A SENSOR B" }, { identifier: "A SENSOR C" }, { identifier: "A SENSOR IDENTIFIER" }, { identifier: "ANOTHER SENSOR ID", location: "Pulham Road, Battersea" }, { identifier: "CTA Bus 2034 on Route 6", location: "King's Road, Chelsea" }, { identifier: "ANOTHER SENSOR ID", location: "Sydenham High Street, Sydenham" }, { identifier: "CTA Bus 12 on Route 6" }, { identifier: "CTA Bus 93 on Route 12" }, { identifier: "CTA Bus 86 on Route 1" }, { identifier: "CTA Bus 123 on Route 5" }, { identifier: "CTA Bus 93 on Route 12" }, { identifier: "CTA Bus 86 on Route 1" }, { identifier: "CTA Bus 123 on Route 5" }, { identifier: "CTA Bus 93 on Route 12" }, { identifier: "CTA Bus 86 on Route 1" }, { identifier: "CTA Bus 123 on Route 5" }];
