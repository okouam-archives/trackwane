...
namespace Trackwane.Tests
{
    internal partial class Scenario
    {
        ...
        protected static TrackwaneClient Client { get; set; }
        ...
        protected static TrackwaneClient SetupClient(string appKey = null)
        {
            ...
            return new TrackwaneClient(server, protocol, apiPort, secretKey, metricsPort, appKey);
        }
